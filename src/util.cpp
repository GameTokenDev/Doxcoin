...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\dox
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\dox
    // Mac: ~/Library/Application Support/dox
    // Unix: ~/.dox
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "dox";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "dox.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "doxd.pid"));
