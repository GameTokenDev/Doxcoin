...
bool CWalletDB::WriteDoxmasterNodeConfig(std::string sAlias, const CDoxmasterNodeConfig& nodeConfig)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("doxmaster"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadDoxmasterNodeConfig(std::string sAlias, CDoxmasterNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("doxmaster"), sAlias), nodeConfig);
}

bool CWalletDB::EraseDoxmasterNodeConfig(std::string sAlias)
{
    nWalletDBUpdated++;
    return Erase(std::make_pair(std::string("doxmaster"), sAlias));
}
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        else if (strType == "doxmaster")
	{
	    std::string sAlias;
	    ssKey >> sAlias;
	    CDoxmasterNodeConfig doxmasterNodeConfig;
	    ssValue >> doxmasterNodeConfig;
	    pwallet->mapMyDoxmasterNodes.insert(make_pair(sAlias, doxmasterNodeConfig));
	}
    } catch (...)
    {
        return false;
