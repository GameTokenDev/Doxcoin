...
{
    resize(750, 425);
    setWindowTitle(tr("dox") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("dox");
    setStyleSheet("#dox { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #efefef, stop: 1 #dedede);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a dox address"));
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/bitcoin"), tr("&Doxmaster"), this);
    masternodeManagerAction->setToolTip(tr("Show Doxmaster Nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(tr("&About dox"), this);
    aboutAction->setToolTip(tr("Show information about dox"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for dox"));
...
void BitcoinGUI::createToolBars()
{
    ...
    menuAction->setToolTip(tr("Access dox Wallet Tabs"));
...
{
    if(!fOnlyTor)
    netLabel->setText("MASTERNODENET");
    else
    {
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("dox client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("dox client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to dox network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid dox address or malformed URI parameters."));
    }
