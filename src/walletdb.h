...
public:
    ...
    bool WriteDoxmasterNodeConfig(std::string sAlias, const CDoxmasterNodeConfig& nodeConfig);
    bool ReadDoxmasterNodeConfig(std::string sAlias, CDoxmasterNodeConfig& nodeConfig);
    bool EraseDoxmasterNodeConfig(std::string sAlias);
